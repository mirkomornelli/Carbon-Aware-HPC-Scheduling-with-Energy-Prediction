...
from project_rebuild.carbon_model import load_and_prepare_jobs, train_energy_model
from project_rebuild.plotting import save_energy_plots


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train energy/carbon prediction model.")
    parser.add_argument("--input", type=Path, default=ROOT.parent / "project" / "job_table.parquet")
